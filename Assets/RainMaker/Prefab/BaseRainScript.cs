...
namespace DigitalRuby.RainMaker
{
    public class BaseRainScript : MonoBehaviour
    {
        ...
        [Range(0.0f, 1.0f)]
        public float VolumenAmbiente = 0.02f;

        [Range(0.0f, 1.0f)]
        public float VolumenLluvia = 0.09f;
        ...
        {
            audioSourceWind.AudioSource.volume = VolumenAmbiente;
            ...
            if (lastRainIntensityValue != RainIntensity)
            {
                ...
                else
                {
                    ...
                    if (audioSourceRainCurrent != newSource)
                    {
                        ...
                        audioSourceRainCurrent.Play(VolumenLluvia);
                    }
                    if (RainFallParticleSystem != null)
                    {
                        ParticleSystem.EmissionModule e = RainFallParticleSystem.emission;
